#line 1 "..\\Driver\\HardWare\\USART\\USART.c"
...
#line 11 "..\\Driver\\HeaderFiles\\HeaderFiles.h"
...
#line 1 "..\\Driver\\HardWare\\USART\\USART.h"
#line 49 "..\\Driver\\HardWare\\USART\\USART.h"
...
#line 21 "..\\Driver\\HeaderFiles\\HeaderFiles.h"
...
#line 22 "..\\Driver\\HeaderFiles\\HeaderFiles.h"
#line 1 "..\\Driver\\HardWare\\LED\\LED.h"




#line 6 "..\\Driver\\HardWare\\LED\\LED.h"
...
#line 14 "..\\Driver\\Fatfs\\integer.h"
...
#line 25 "..\\Driver\\Fatfs\\ff.h"
#line 1 "..\\Driver\\Fatfs\\ffconf.h"
...
#line 1 "..\\Driver\\HardWare\\KEY\\Key.h"



#line 5 "..\\Driver\\HardWare\\KEY\\Key.h"

#line 15 "..\\Driver\\HardWare\\KEY\\Key.h"
...
extern uint8_t g_key_stable_level[4];
...
#line 26 "..\\Driver\\HeaderFiles\\HeaderFiles.h"
#line 1 "..\\sysFunction\\bootloader.h"
#line 4 "..\\sysFunction\\bootloader.h"
...
uint8_t appbin_read_write(void);
uint8_t flash_erase_nsector(uint32_t saddr, uint8_t n);
uint8_t flash_erase_app(void);
uint8_t flash_write_app(uint32_t saddr, uint8_t* data, uint32_t size);

char *f_gets(char *buff, int len, FIL *fp);


#line 27 "..\\Driver\\HeaderFiles\\HeaderFiles.h"
...
#line 1 "..\\sysFunction\\file_mgr.h"
#line 4 "..\\sysFunction\\file_mgr.h"
 
#line 27 "..\\sysFunction\\file_mgr.h"
...
#line 2 "..\\Driver\\HardWare\\USART\\USART.c"
...
void rs485_printf(const char *fmt, ...)
{
    ...
    gpio_bit_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U), ((uint32_t)((uint32_t)0x01U<<(8))));

    if (n < 0) {
        gpio_bit_reset(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U), ((uint32_t)((uint32_t)0x01U<<(8))));
        return;
    }
    ...
    dma_enable(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH6, len);
    
    
    for (uint32_t i = 0; i < 100000 && dma_flag_get(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH6, ((uint32_t)((uint32_t)0x01U<<(5)))) == RESET; i++);
    
    
    for (uint32_t i = 0; i < 100000 && usart_flag_get((((uint32_t)0x40000000U) + 0x00004400U), USART_FLAG_TC) == RESET; i++);
...
void USART1_Init(void)
{
    ...
    gpio_mode_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(8))));
    gpio_output_options_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), ((uint32_t)((uint32_t)0x01U<<(8))));
    gpio_bit_reset(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U), ((uint32_t)((uint32_t)0x01U<<(8)))); 
    
    
    gpio_mode_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000C00U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(5))));
    gpio_af_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000C00U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(7) << 0)), ((uint32_t)((uint32_t)0x01U<<(5))));

    
    gpio_mode_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000C00U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(6))));
    gpio_af_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000C00U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(7) << 0)), ((uint32_t)((uint32_t)0x01U<<(6))));
    ...
    usart_word_length_set((((uint32_t)0x40000000U) + 0x00004400U), (((uint32_t)((uint32_t)0x01U<<(12))) & ((uint32_t)(0) << 12)));
    usart_stop_bit_set((((uint32_t)0x40000000U) + 0x00004400U), (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(0) << 12)));
    usart_parity_config((((uint32_t)0x40000000U) + 0x00004400U), (((0xFFFFFFFFUL << (9)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(0) << 9)));
    ...
    usart_dma_transmit_config((((uint32_t)0x40000000U) + 0x00004400U), (((uint32_t)((uint32_t)0x01U<<(7))) & ((uint32_t)(1) << 7)));
    usart_dma_receive_config((((uint32_t)0x40000000U) + 0x00004400U), (((uint32_t)((uint32_t)0x01U<<(6))) & ((uint32_t)(1) << 6)));
    
    
    nvic_irq_enable(USART1_IRQn, 2, 0);  
    usart_interrupt_enable((((uint32_t)0x40000000U) + 0x00004400U), USART_INT_IDLE);     
...
void USART1_SendData(uint16_t *buf, uint16_t len)
{
    ...
    gpio_bit_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U), ((uint32_t)((uint32_t)0x01U<<(8))));
    dma_enable(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH6, len);
    while(dma_flag_get(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH6, ((uint32_t)((uint32_t)0x01U<<(5)))) == RESET); 
    while(usart_flag_get((((uint32_t)0x40000000U) + 0x00004400U), USART_FLAG_TC) == RESET);
    gpio_bit_reset(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U), ((uint32_t)((uint32_t)0x01U<<(8))));
}
...
void USART1_IRQHandler(void)
{
    ...
    if (RESET != usart_interrupt_flag_get((((uint32_t)0x40000000U) + 0x00004400U), USART_INT_FLAG_IDLE))
    {
        data_recv = usart_data_receive((((uint32_t)0x40000000U) + 0x00004400U));
