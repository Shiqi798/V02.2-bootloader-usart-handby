#line 1 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_syscfg.c"
...
#line 36 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_syscfg.c"
...
void syscfg_bootmode_config(uint8_t syscfg_bootmode)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x00U)) &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x00U)) |= (uint32_t)syscfg_bootmode;
}
...
{
    uint32_t reg;
    reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x00U));
     
    reg &= ~((uint32_t)((uint32_t)0x01U<<(8)));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x00U)) = (reg | syscfg_fmc_swap);
}
...
void syscfg_exmc_swap_config(uint32_t syscfg_exmc_swap)
{
    ...
    reg &= ~((0xFFFFFFFFUL << (10)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x00U)) = (reg | syscfg_exmc_swap);
}
...
void syscfg_exti_line_config(uint8_t exti_port, uint8_t exti_pin)
{
    ...
    case ((uint8_t)0x00U):
        ...
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x08U)) &= clear_exti_mask;
         
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x08U)) |= config_exti_mask;
        break;
    case ((uint8_t)0x01U):
         
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x0CU)) &= clear_exti_mask;
         
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x0CU)) |= config_exti_mask;
        break;
    case ((uint8_t)0x02U):
         
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x10U)) &= clear_exti_mask;
         
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x10U)) |= config_exti_mask;
        break;
    case ((uint8_t)0x03U):
         
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x14U)) &= clear_exti_mask;
         
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x14U)) |= config_exti_mask;
        break;
    default:
        break;
    }
...
void syscfg_enet_phy_interface_config(uint32_t syscfg_enet_phy_interface)
{
    ...
    reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x04U));
     
    reg &= ~((uint32_t)((uint32_t)0x01U<<(23)));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x04U)) = (reg | syscfg_enet_phy_interface);
}
...
void syscfg_compensation_config(uint32_t syscfg_compensation)
{
    ...
    reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x20U));
     
    reg &= ~((uint32_t)((uint32_t)0x01U<<(0)));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x20U)) = (reg | syscfg_compensation);
}
...
FlagStatus syscfg_flag_get(void)
{
    if(((uint32_t)RESET) != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00003800U) + 0x20U)) & ((uint32_t)((uint32_t)0x01U<<(8))))) {
        return SET;
    } else {
        return RESET;
    }
