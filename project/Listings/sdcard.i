#line 1 "..\\Driver\\HardWare\\SDCARD\\sdcard.c"
...
#line 1 "..\\Driver\\HardWare\\SDCARD\\sdcard.h"
...
#line 42 "..\\Driver\\HardWare\\SDCARD\\sdcard.h"

 
#line 71 "..\\Driver\\HardWare\\SDCARD\\sdcard.h"

 
#line 80 "..\\Driver\\HardWare\\SDCARD\\sdcard.h"

 
#line 91 "..\\Driver\\HardWare\\SDCARD\\sdcard.h"
...
typedef enum
{
    ...
    SDIO_HIGH_CAPACITY_MULTIMEDIA_CARD,    
...
typedef struct
{
    ...
    volatile uint16_t oid;                     
    volatile uint32_t pnm0;                    
    volatile uint8_t pnm1;                     
    volatile uint8_t prv;                      
    volatile uint32_t psn;                     
    volatile uint16_t mdt;                     
...
typedef struct
{
    volatile uint8_t csd_struct;               
    volatile uint8_t taac;                     
    volatile uint8_t nsac;                     
    volatile uint8_t tran_speed;               
    volatile uint16_t ccc;                     
    volatile uint8_t read_bl_len;              
    volatile uint8_t read_bl_partial;          
    volatile uint8_t write_blk_misalign;       
    volatile uint8_t read_blk_misalign;        
    volatile uint8_t dsp_imp;                  
    volatile uint32_t c_size;                  
    volatile uint8_t vdd_r_curr_min;           
    volatile uint8_t vdd_r_curr_max;           
    volatile uint8_t vdd_w_curr_min;           
    volatile uint8_t vdd_w_curr_max;           
    volatile uint8_t c_size_mult;              
    volatile uint8_t erase_blk_en;             
    volatile uint8_t sector_size;              
    volatile uint8_t wp_grp_size;              
    volatile uint8_t wp_grp_enable;            
    volatile uint8_t r2w_factor;               
    volatile uint8_t write_bl_len;             
    volatile uint8_t write_bl_partial;         
    volatile uint8_t file_format_grp;          
    volatile uint8_t copy_flag;                
    volatile uint8_t perm_write_protect;       
    volatile uint8_t tmp_write_protect;        
...
typedef struct
{
    sd_cid_struct card_cid;                
    sd_csd_struct card_csd;                
    sdio_card_type_enum card_type;         
...
#line 39 "..\\Driver\\HardWare\\SDCARD\\sdcard.c"
#line 40 "..\\Driver\\HardWare\\SDCARD\\sdcard.c"
#line 41 "..\\Driver\\HardWare\\SDCARD\\sdcard.c"
...
#line 42 "..\\Driver\\HardWare\\SDCARD\\sdcard.c"

 
#line 65 "..\\Driver\\HardWare\\SDCARD\\sdcard.c"
...
#line 82 "..\\Driver\\HardWare\\SDCARD\\sdcard.c"
...
#line 111 "..\\Driver\\HardWare\\SDCARD\\sdcard.c"



uint32_t sd_scr[2] = {0,0};                                            

static sdio_card_type_enum cardtype = SDIO_STD_CAPACITY_SD_CARD_V1_1;  
static uint32_t sd_csd[4] = {0,0,0,0};                                 
static uint32_t sd_cid[4] = {0,0,0,0};                                 
static uint16_t sd_rca = 0;                                            
static uint32_t transmode = ((uint32_t)0x00000001);
static uint32_t totalnumber_bytes = 0, stopcondition = 0;
static volatile sd_error_enum transerror = SD_OK;
static volatile uint32_t transend = 0, number_bytes = 0;
...
sd_error_enum sd_init(void)
{
    ...
    sdio_clock_config((uint32_t)0x00000000U, (uint32_t)0x00000000U, (uint32_t)0x00000000U, ((uint16_t)0x0000));
    sdio_bus_mode_set((((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(12)))) & ((uint32_t)(0) << 11)));
...
sd_error_enum sd_card_init(void)
{
    ...
    if((((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)) == sdio_power_state_get()){
    ...
    if(SDIO_SECURE_DIGITAL_IO_CARD != cardtype){
        ...
        sdio_command_response_config(((uint8_t)2), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(3) << 6)));
        sdio_wait_type_set((uint32_t)0x00000000U);
        sdio_csm_enable();
        ...
        sd_cid[0] = sdio_response_get((uint32_t)0x00000000U);
        sd_cid[1] = sdio_response_get((uint32_t)0x00000001U);
        sd_cid[2] = sdio_response_get((uint32_t)0x00000002U);
        sd_cid[3] = sdio_response_get((uint32_t)0x00000003U);
    }
    ...
    if ((SDIO_STD_CAPACITY_SD_CARD_V1_1 == cardtype) || (SDIO_STD_CAPACITY_SD_CARD_V2_0 == cardtype) || 
        ...
        sdio_command_response_config(((uint8_t)3), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
        sdio_wait_type_set((uint32_t)0x00000000U);
        sdio_csm_enable();
         
        status = r6_error_check(((uint8_t)3), &temp_rca);
        if(SD_OK != status){
            return status;
        }
    }
    ...
    if(SDIO_SECURE_DIGITAL_IO_CARD != cardtype){
        ...
        sdio_command_response_config(((uint8_t)9), (uint32_t)(temp_rca << ((uint8_t)0x10)), (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(3) << 6)));
        sdio_wait_type_set((uint32_t)0x00000000U);
        sdio_csm_enable();
        ...
        sd_csd[0] = sdio_response_get((uint32_t)0x00000000U);
        sd_csd[1] = sdio_response_get((uint32_t)0x00000001U);
        sd_csd[2] = sdio_response_get((uint32_t)0x00000002U);
        sd_csd[3] = sdio_response_get((uint32_t)0x00000003U);
    }
    return status;
}
...
{
    sd_error_enum status = SD_OK;
    uint32_t sdcardtype = ((uint32_t)0x00000000), response = 0, count = 0;
    uint8_t busyflag = 0;
    
     
    sdio_clock_config((uint32_t)0x00000000U, (uint32_t)0x00000000U, (uint32_t)0x00000000U, ((uint16_t)0x0076));
    sdio_bus_mode_set((((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(12)))) & ((uint32_t)(0) << 11)));
    sdio_hardware_clock_disable();
    sdio_power_state_set((((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)));
     
    sdio_clock_enable();
    
     
    sdio_command_response_config(((uint8_t)0), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(0) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    ...
    sdio_command_response_config(((uint8_t)8), ((uint32_t)0x000001AA), (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
    ...
    if(SD_OK == r7_error_check()){
        ...
        sdcardtype = ((uint32_t)0x40000000);
    }
    
     
    sdio_command_response_config(((uint8_t)55), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
    
    if(SD_OK == r1_error_check(((uint8_t)55))){
         
        while((!busyflag) && (count < ((uint32_t)0x0000FFFF))){
             
            sdio_command_response_config(((uint8_t)55), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
            sdio_wait_type_set((uint32_t)0x00000000U);
            sdio_csm_enable();
             
            status = r1_error_check(((uint8_t)55));
            if(SD_OK != status){
                return status;
            }
            
             
            sdio_command_response_config(((uint8_t)41), (((uint32_t)0x80100000) | sdcardtype), (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
            sdio_wait_type_set((uint32_t)0x00000000U);
            sdio_csm_enable();
            ...
            response = sdio_response_get((uint32_t)0x00000000U);
...
{
    sd_error_enum status = SD_OK;
    sdio_power_state_set((((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)));
    return status;
}
...
sd_error_enum sd_bus_mode_config(uint32_t busmode)
{
    ...
    if(SDIO_MULTIMEDIA_CARD == cardtype){
        ...
        if((((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(12)))) & ((uint32_t)(2) << 11)) == busmode){
             
            status = SD_FUNCTION_UNSUPPORTED;
            return status;
        }else if((((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(12)))) & ((uint32_t)(1) << 11)) == busmode){
             
            status = sd_bus_width_config(((uint32_t)0x00040000));
            if(SD_OK == status){
                sdio_clock_config((uint32_t)0x00000000U, (uint32_t)0x00000000U,
                                    (uint32_t)0x00000000U, ((uint16_t)0x0000));
                sdio_bus_mode_set(busmode);
                sdio_hardware_clock_disable();
            }
        }else if((((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(12)))) & ((uint32_t)(0) << 11)) == busmode){
             
            status = sd_bus_width_config(((uint32_t)0x00010000));
            if(SD_OK == status){
                sdio_clock_config((uint32_t)0x00000000U, (uint32_t)0x00000000U, 
                                    (uint32_t)0x00000000U, ((uint16_t)0x0000));
                sdio_bus_mode_set(busmode);
...
sd_error_enum sd_transfer_mode_config(uint32_t txmode)
{
    ...
    if((((uint32_t)0x00000000) == txmode) || (((uint32_t)0x00000001) == txmode)){
        transmode = txmode;
    }else{
        status = SD_PARAMETER_INVALID;
    }
...
sd_error_enum sd_block_read(uint32_t *preadbuffer, uint32_t readaddr, uint16_t blocksize)
{
    ...
    sd_error_enum status = SD_OK;
    uint32_t count = 0, align = 0, datablksize = (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(0) << 4)), *ptempbuff = preadbuffer;
    ...
    sdio_data_config(0, 0, (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(0) << 4)));
    sdio_data_transfer_config((uint32_t)0x00000000U, (uint32_t)0x00000000U);
    sdio_dsm_disable();
    sdio_dma_disable();
    
     
    if(sdio_response_get((uint32_t)0x00000000U) & ((uint32_t)0x02000000)){
    ...
    if((blocksize > 0) && (blocksize <= 2048) && (0 == align)){
        ...
        sdio_command_response_config(((uint8_t)16), (uint32_t)blocksize, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
        sdio_wait_type_set((uint32_t)0x00000000U);
        sdio_csm_enable();
        
         
        status = r1_error_check(((uint8_t)16));
        if(SD_OK != status){
            return status;
        }
    }else{
    ...
    sdio_data_config(((uint32_t)0xFFFFFFFF), totalnumber_bytes, datablksize);
    sdio_data_transfer_config(((uint32_t)((uint32_t)0x01U<<(1))), (uint32_t)0x00000000U);
    sdio_dsm_enable();
    
     
    sdio_command_response_config(((uint8_t)17), (uint32_t)readaddr, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
     
    status = r1_error_check(((uint8_t)17));
    if(SD_OK != status){
        return status;
    }
    
    if(((uint32_t)0x00000001) == transmode){
         
        while(!sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(10))) | ((uint32_t)((uint32_t)0x01U<<(9))))){
            if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(15))))){
                 
                for(count = 0; count < ((uint32_t)0x00000008); count++){
                    *(ptempbuff + count) = sdio_data_read();
                }
                ptempbuff += ((uint32_t)0x00000008);
            }
        }
        
         
        if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(1))))){
            status = SD_DATA_CRC_ERROR;
            sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(1))));
            return status;
        }else if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(3))))){
            status = SD_DATA_TIMEOUT;
            sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(3))));
            return status;
        }else if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(5))))){
            status = SD_RX_OVERRUN_ERROR;
            sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(5))));
            return status;
        }else if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(9))))){
            status = SD_START_BIT_ERROR;
            sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(9))));
            return status;
        }
        while(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(21))))){
            *ptempbuff = sdio_data_read();
            ++ptempbuff;
        }
         
        sdio_flag_clear(((uint32_t)0x00C007FF));
    }else if(((uint32_t)0x00000000) == transmode){
         
         
        sdio_interrupt_enable(((uint32_t)((uint32_t)0x01U<<(0))) | ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))));
        sdio_dma_enable();
        dma_receive_config(preadbuffer, blocksize);
        timeout = 100000;
        while((RESET == dma_flag_get(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3, ((uint32_t)((uint32_t)0x01U<<(5))))) && (timeout > 0)){
            timeout--;
            if(0 == timeout){
                return SD_ERROR;
            }
...
sd_error_enum sd_multiblocks_read(uint32_t *preadbuffer, uint32_t readaddr, uint16_t blocksize, uint32_t blocksnumber)
{
    ...
    if(blocksnumber > 1){
        if(blocksnumber * blocksize > ((uint32_t)0x01FFFFFF)){
        ...
        sdio_command_response_config(((uint8_t)18), readaddr, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
        sdio_wait_type_set((uint32_t)0x00000000U);
        sdio_csm_enable();
         
        status = r1_error_check(((uint8_t)18));
        if(SD_OK != status){
            return status;
        }
        ...
        if(((uint32_t)0x00000001) == transmode){
            ...
            while(!sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))))){
                if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(15))))){
            ...
            if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(8))))){
                if((SDIO_STD_CAPACITY_SD_CARD_V1_1 == cardtype) || (SDIO_STD_CAPACITY_SD_CARD_V2_0 == cardtype) || 
                    (SDIO_HIGH_CAPACITY_SD_CARD == cardtype)){
                     
                    sdio_command_response_config(((uint8_t)12), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
                    sdio_wait_type_set((uint32_t)0x00000000U);
                    sdio_csm_enable();
                     
                    status = r1_error_check(((uint8_t)12));
                    if(SD_OK != status){
                        return status;
                    }
                }
            ...
            sdio_interrupt_enable(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))));
            sdio_dma_enable();
...
sd_error_enum sd_block_write(uint32_t *pwritebuffer, uint32_t writeaddr, uint16_t blocksize)
{
    ...
    sd_error_enum status = SD_OK;
    uint8_t cardstate = 0;
    uint32_t count = 0, align = 0, datablksize = (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(0) << 4)), *ptempbuff = pwritebuffer;
    ...
    sdio_command_response_config(((uint8_t)13), (uint32_t)sd_rca << ((uint8_t)0x10), (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
     
    status = r1_error_check(((uint8_t)13));
    if(SD_OK != status){
        return status;
    }
    ...
    while((0 == (response & ((uint32_t)((uint32_t)0x01U<<(8))))) && (timeout > 0)){
    ...
    sdio_command_response_config(((uint8_t)24), writeaddr, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
     
    status = r1_error_check(((uint8_t)24));
    if(SD_OK != status){
        return status;
    }
    ...
    if(((uint32_t)0x00000001) == transmode){
        ...
        while(!sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(4))) | ((uint32_t)((uint32_t)0x01U<<(10))) | ((uint32_t)((uint32_t)0x01U<<(9))))){
            if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(14))))){
                 
                if((totalnumber_bytes - transbytes) < ((uint32_t)0x00000020)){
                    ...
                    ptempbuff += ((uint32_t)0x00000008);
                    transbytes += ((uint32_t)0x00000020);
                }
            }
        }
        ...
        if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(1))))){
            ...
            sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(3))));
            return status;
        }else if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(4))))){
            status = SD_TX_UNDERRUN_ERROR;
            sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(4))));
            return status;
        }else if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(9))))){
            status = SD_START_BIT_ERROR;
            sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(9))));
        ...
        sdio_interrupt_enable(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(4))) | ((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))));
    ...
    while((SD_OK == status) && ((((uint8_t)0x07) == cardstate) || (((uint8_t)0x06) == cardstate))){
        status = sd_card_state_get(&cardstate);
    }
    return status;
}
...
sd_error_enum sd_multiblocks_write(uint32_t *pwritebuffer, uint32_t writeaddr, uint16_t blocksize, uint32_t blocksnumber)
{
    ...
    if(blocksnumber > 1){
        ...
        if((SDIO_STD_CAPACITY_SD_CARD_V1_1 == cardtype) || (SDIO_STD_CAPACITY_SD_CARD_V2_0 == cardtype) || 
            ...
            sdio_command_response_config(((uint8_t)55), (uint32_t)sd_rca << ((uint8_t)0x10), (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
            sdio_wait_type_set((uint32_t)0x00000000U);
            sdio_csm_enable();
            ...
            sdio_command_response_config(((uint8_t)23), blocksnumber, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
            sdio_wait_type_set((uint32_t)0x00000000U);
            sdio_csm_enable();
             
            status = r1_error_check(((uint8_t)23));
            if(SD_OK != status){
                return status;
            }
        }
         
        sdio_command_response_config(((uint8_t)25), writeaddr, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
        sdio_wait_type_set((uint32_t)0x00000000U);
        sdio_csm_enable();
         
        status = r1_error_check(((uint8_t)25));
        if(SD_OK != status){
            return status;
        }
        ...
        if(((uint32_t)0x00000001) == transmode){
            ...
            while(!sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(4))) | ((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))))){
                if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(14))))){
...
sd_error_enum sd_erase(uint32_t startaddr, uint32_t endaddr)
{
    ...
    tempbyte = (uint8_t)((sd_csd[1] & ((uint32_t)0xFF000000)) >> 24);
    tempccc = (uint16_t)((uint16_t)tempbyte << 4);
    tempbyte = (uint8_t)((sd_csd[1] & ((uint32_t)0x00FF0000)) >> 16);
    tempccc |= (uint16_t)((uint16_t)(tempbyte & 0xF0) >> 4);
    if(0 == (tempccc & ((uint32_t)((uint32_t)0x01U<<(5))))){
         
        status = SD_FUNCTION_UNSUPPORTED;
        return status;
    }
    clkdiv = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002C00U) + 0x00000004U)) & ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))));
    clkdiv += (((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002C00U) + 0x00000004U)) & ((uint32_t)((uint32_t)0x01U<<(31))))>>31)*256;
    clkdiv += 2;
    delay = 168000 / clkdiv;
    ...
    if((SDIO_STD_CAPACITY_SD_CARD_V1_1 == cardtype) || (SDIO_STD_CAPACITY_SD_CARD_V2_0 == cardtype) || 
        ...
        sdio_command_response_config(((uint8_t)32), startaddr, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
        sdio_wait_type_set((uint32_t)0x00000000U);
        sdio_csm_enable();
         
        status = r1_error_check(((uint8_t)32));
        if(SD_OK != status){
            return status;
        }
        
         
        sdio_command_response_config(((uint8_t)33), endaddr, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
        sdio_wait_type_set((uint32_t)0x00000000U);
        sdio_csm_enable();
         
        status = r1_error_check(((uint8_t)33));
        if(SD_OK != status){
            return status;
        }
    }
    ...
    sdio_command_response_config(((uint8_t)38), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
     
    status = r1_error_check(((uint8_t)38));
    if(SD_OK != status){
        return status;
    }
...
{
    transerror = SD_OK;
    if(RESET != sdio_interrupt_flag_get(((uint32_t)((uint32_t)0x01U<<(8))))){
        ...
        sdio_interrupt_flag_clear(((uint32_t)((uint32_t)0x01U<<(8))));
         
        sdio_interrupt_disable(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))) | 
                                ((uint32_t)((uint32_t)0x01U<<(14))) | ((uint32_t)((uint32_t)0x01U<<(15))) | ((uint32_t)((uint32_t)0x01U<<(4))) | ((uint32_t)((uint32_t)0x01U<<(5))));
        transend = 1;
        number_bytes = 0;
        return transerror;
    }
    
    if(RESET != sdio_interrupt_flag_get(((uint32_t)((uint32_t)0x01U<<(1))))){
        sdio_interrupt_flag_clear(((uint32_t)((uint32_t)0x01U<<(1))));
    ...
    if(RESET != sdio_interrupt_flag_get(((uint32_t)((uint32_t)0x01U<<(3))))){
        sdio_interrupt_flag_clear(((uint32_t)((uint32_t)0x01U<<(3))));
    ...
    if(RESET != sdio_interrupt_flag_get(((uint32_t)((uint32_t)0x01U<<(9))))){
        sdio_interrupt_flag_clear(((uint32_t)((uint32_t)0x01U<<(9))));
    ...
    if(RESET != sdio_interrupt_flag_get(((uint32_t)((uint32_t)0x01U<<(4))))){
        sdio_interrupt_flag_clear(((uint32_t)((uint32_t)0x01U<<(4))));
    ...
    if(RESET != sdio_interrupt_flag_get(((uint32_t)((uint32_t)0x01U<<(5))))){
        sdio_interrupt_flag_clear(((uint32_t)((uint32_t)0x01U<<(5))));
...
sd_error_enum sd_card_select_deselect(uint16_t cardrca)
{
    ...
    sdio_command_response_config(((uint8_t)7), (uint32_t)(cardrca << ((uint8_t)0x10)), (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
    
    status = r1_error_check(((uint8_t)7));
    return status;
}
...
sd_error_enum sd_cardstatus_get(uint32_t *pcardstatus)
{
    ...
    *pcardstatus = sdio_response_get((uint32_t)0x00000000U);
    return status;
}
...
sd_error_enum sd_sdstatus_get(uint32_t *psdstatus)
{
    ...
    sdio_command_response_config(((uint8_t)16), (uint32_t)64, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
    ...
    sdio_data_config(((uint32_t)0xFFFFFFFF), (uint32_t)64, (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(6) << 4)));
    sdio_data_transfer_config(((uint32_t)((uint32_t)0x01U<<(1))), (uint32_t)0x00000000U);
    sdio_dsm_enable();
    
     
    sdio_command_response_config(((uint8_t)13), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
...
sd_error_enum sd_lock_unlock(uint8_t lockstate)
{
    ...
    if(0 == (tempccc & ((uint32_t)((uint32_t)0x01U<<(7))))){
    ...
    sdio_command_response_config(((uint8_t)16), (uint32_t)8, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
    ...
    sdio_command_response_config(((uint8_t)42), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
     
    status = r1_error_check(((uint8_t)42));
    if(SD_OK != status){
        return status;
    }
    ...
    sdio_data_config(((uint32_t)0xFFFFFFFF), (uint32_t)8, (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(3) << 4)));
    sdio_data_transfer_config((uint32_t)0x00000000U, (uint32_t)0x00000000U);
    sdio_dsm_enable();
...
sd_transfer_state_enum sd_transfer_state_get(void)
{
    ...
    if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(12))) | ((uint32_t)((uint32_t)0x01U<<(13))))){
...
uint32_t sd_card_capacity_get(void)
{
    ...
    if((SDIO_STD_CAPACITY_SD_CARD_V1_1 == cardtype) || (SDIO_STD_CAPACITY_SD_CARD_V2_0 == cardtype)){
        ...
        tempbyte = (uint8_t)((sd_csd[1] & ((uint32_t)0x0000FF00)) >> 8);
        devicesize |= (uint32_t)((uint32_t)(tempbyte & 0x03) << 10);
        tempbyte = (uint8_t)(sd_csd[1] & ((uint32_t)0x000000FF));
        devicesize |= (uint32_t)((uint32_t)tempbyte << 2);
        tempbyte = (uint8_t)((sd_csd[2] & ((uint32_t)0xFF000000)) >> 24);
        devicesize |= (uint32_t)((uint32_t)(tempbyte & 0xC0) >> 6);
        
         
        tempbyte = (uint8_t)((sd_csd[2] & ((uint32_t)0x00FF0000)) >> 16);
        devicesize_mult = (tempbyte & 0x03) << 1;
        tempbyte = (uint8_t)((sd_csd[2] & ((uint32_t)0x0000FF00)) >> 8);
...
sd_error_enum sd_card_information_get(sd_card_info_struct *pcardinfo)
{
    ...
    tempbyte = (uint8_t)((sd_cid[0] & ((uint32_t)0xFF000000)) >> 24);
    pcardinfo->card_cid.mid = tempbyte;
    
     
    tempbyte = (uint8_t)((sd_cid[0] & ((uint32_t)0x00FF0000)) >> 16);
    pcardinfo->card_cid.oid = (uint16_t)((uint16_t)tempbyte << 8);
    
     
    tempbyte = (uint8_t)((sd_cid[0] & ((uint32_t)0x0000FF00)) >> 8);
    pcardinfo->card_cid.oid |= (uint16_t)tempbyte;
    
     
    tempbyte = (uint8_t)(sd_cid[0] & ((uint32_t)0x000000FF));
    pcardinfo->card_cid.pnm0 = (uint32_t)((uint32_t)tempbyte << 24);
    
     
    tempbyte = (uint8_t)((sd_cid[1] & ((uint32_t)0xFF000000)) >> 24);
    pcardinfo->card_cid.pnm0 |= (uint32_t)((uint32_t)tempbyte << 16);
    
     
    tempbyte = (uint8_t)((sd_cid[1] & ((uint32_t)0x00FF0000)) >> 16);
    pcardinfo->card_cid.pnm0 |= (uint32_t)((uint32_t)tempbyte << 8);
    
     
    tempbyte = (uint8_t)((sd_cid[1] & ((uint32_t)0x0000FF00)) >> 8);
    pcardinfo->card_cid.pnm0 |= (uint32_t)(tempbyte);
    
     
    tempbyte = (uint8_t)(sd_cid[1] & ((uint32_t)0x000000FF));
    pcardinfo->card_cid.pnm1 = tempbyte;
    
     
    tempbyte = (uint8_t)((sd_cid[2] & ((uint32_t)0xFF000000)) >> 24);
    pcardinfo->card_cid.prv = tempbyte;
    
     
    tempbyte = (uint8_t)((sd_cid[2] & ((uint32_t)0x00FF0000)) >> 16);
    pcardinfo->card_cid.psn = (uint32_t)((uint32_t)tempbyte << 24);
    
     
    tempbyte = (uint8_t)((sd_cid[2] & ((uint32_t)0x0000FF00)) >> 8);
    pcardinfo->card_cid.psn |= (uint32_t)((uint32_t)tempbyte << 16);
    
     
    tempbyte = (uint8_t)(sd_cid[2] & ((uint32_t)0x000000FF));
    pcardinfo->card_cid.psn |= (uint32_t)tempbyte;
    
     
    tempbyte = (uint8_t)((sd_cid[3] & ((uint32_t)0xFF000000)) >> 24);
    pcardinfo->card_cid.psn |= (uint32_t)tempbyte;
    
     
    tempbyte = (uint8_t)((sd_cid[3] & ((uint32_t)0x00FF0000)) >> 16);
    pcardinfo->card_cid.mdt = (uint16_t)((uint16_t)(tempbyte & 0x0F) << 8);
    
     
    tempbyte = (uint8_t)((sd_cid[3] & ((uint32_t)0x0000FF00)) >> 8);
    pcardinfo->card_cid.mdt |= (uint16_t)tempbyte;
    
     
    tempbyte = (uint8_t)(sd_cid[3] & ((uint32_t)0x000000FF));
    pcardinfo->card_cid.cid_crc = (tempbyte & 0xFE) >> 1;
    
     
    tempbyte = (uint8_t)((sd_csd[0] & ((uint32_t)0xFF000000)) >> 24);
    pcardinfo->card_csd.csd_struct = (tempbyte & 0xC0) >> 6;
    
     
    tempbyte = (uint8_t)((sd_csd[0] & ((uint32_t)0x00FF0000)) >> 16);
    pcardinfo->card_csd.taac = tempbyte;
    
     
    tempbyte = (uint8_t)((sd_csd[0] & ((uint32_t)0x0000FF00)) >> 8);
    pcardinfo->card_csd.nsac = tempbyte;
    
     
    tempbyte = (uint8_t)(sd_csd[0] & ((uint32_t)0x000000FF));
    ...
    tempbyte = (uint8_t)(sd_csd[2] & ((uint32_t)0x000000FF));
    pcardinfo->card_csd.sector_size |= (tempbyte & 0x80) >> 7;
    pcardinfo->card_csd.wp_grp_size = (tempbyte & 0x7F);
    
     
    tempbyte = (uint8_t)((sd_csd[3] & ((uint32_t)0xFF000000)) >> 24);
    ...
    tempbyte = (uint8_t)(sd_csd[3] & ((uint32_t)0x000000FF));
...
static sd_error_enum cmdsent_error_check(void)
{
    ...
    while((RESET == sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(7))))) && (timeout > 0)){
        --timeout;
    }
...
static sd_error_enum r1_error_type_check(uint32_t resp)
{
    ...
    if(resp & ((uint32_t)((uint32_t)0x01U<<(31)))){
        status = SD_OUT_OF_RANGE;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(30)))){
        status = SD_ADDRESS_ERROR;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(29)))){
        status = SD_BLOCK_LEN_ERROR;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(28)))){
        status = SD_ERASE_SEQ_ERROR;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(27)))){
        status = SD_ERASE_PARAM;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(26)))){
        status = SD_WP_VIOLATION;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(24)))){
        status = SD_LOCK_UNLOCK_FAILED;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(23)))){
        status = SD_COM_CRC_ERROR;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(22)))){
        status = SD_ILLEGAL_COMMAND;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(21)))){
        status = SD_CARD_ECC_FAILED;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(20)))){
        status = SD_CC_ERROR;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(19)))){
        status = SD_GENERAL_UNKNOWN_ERROR;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(16)))){
        status = SD_CSD_OVERWRITE;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(15)))){
        status = SD_WP_ERASE_SKIP;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(14)))){
        status = SD_CARD_ECC_DISABLED;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(13)))){
        status = SD_ERASE_RESET;
    }else if(resp & ((uint32_t)((uint32_t)0x01U<<(3)))){
...
static sd_error_enum r1_error_check(uint8_t cmdindex)
{
    ...
    reg_status = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002C00U) + 0x00000034U));
    while(!(reg_status & (((uint32_t)((uint32_t)0x01U<<(0))) | ((uint32_t)((uint32_t)0x01U<<(2))) | ((uint32_t)((uint32_t)0x01U<<(6)))))){
        reg_status = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002C00U) + 0x00000034U));
    }
     
    if(reg_status & ((uint32_t)((uint32_t)0x01U<<(0)))){
        status = SD_CMD_CRC_ERROR;
        sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(0))));
        return status;
    }else if(reg_status & ((uint32_t)((uint32_t)0x01U<<(2)))){
        status = SD_CMD_RESP_TIMEOUT;
        sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(2))));
        return status;
    }
    ...
    resp_r1 = sdio_response_get((uint32_t)0x00000000U);
    if(((uint32_t)0x00000000) == (resp_r1 & (uint32_t)0xFDF9E008)){
...
static sd_error_enum r3_error_check(void)
{
    ...
    if(reg_status & ((uint32_t)((uint32_t)0x01U<<(2)))){
        status = SD_CMD_RESP_TIMEOUT;
        sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(2))));
        return status;
    }
...
static sd_error_enum r6_error_check(uint8_t cmdindex, uint16_t *prca)
{
    ...
    if(((uint32_t)0x00000000) == (response & (((uint32_t)((uint32_t)0x01U<<(15))) | ((uint32_t)((uint32_t)0x01U<<(14))) | ((uint32_t)((uint32_t)0x01U<<(13)))))){
        *prca = (uint16_t)(response >> 16);
        return status;
    }
     
    if(response & ((uint32_t)((uint32_t)0x01U<<(15)))){
        status = SD_COM_CRC_ERROR;
    }else if(response & ((uint32_t)((uint32_t)0x01U<<(14)))){
        status = SD_ILLEGAL_COMMAND;
    }else if(response & ((uint32_t)((uint32_t)0x01U<<(13)))){
        status = SD_GENERAL_UNKNOWN_ERROR;
    }
    return status;
}
...
static sd_error_enum r7_error_check(void)
{
    ...
    reg_status = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002C00U) + 0x00000034U));
    while(!(reg_status & (((uint32_t)((uint32_t)0x01U<<(0))) | ((uint32_t)((uint32_t)0x01U<<(2))) | ((uint32_t)((uint32_t)0x01U<<(6))))) && (timeout > 0)){
        reg_status = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002C00U) + 0x00000034U));
        --timeout;
    }
    
     
    if((reg_status & ((uint32_t)((uint32_t)0x01U<<(2)))) || (0 == timeout)){
        status = SD_CMD_RESP_TIMEOUT;
        sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(2))));
        return status;
    }
    if(reg_status & ((uint32_t)((uint32_t)0x01U<<(6)))){
        status = SD_OK;
        sdio_flag_clear(((uint32_t)((uint32_t)0x01U<<(6))));
        return status;
    }
    return status;
}
...
{
    sd_error_enum status = SD_OK;
    volatile uint32_t reg_status = 0, response = 0;
    ...
    if(reg_status != (uint32_t)((uint8_t)13)){
        status = SD_ILLEGAL_COMMAND;
        return status;
    }
    ...
    *pcardstate = (uint8_t)((response >> 9) & 0x0000000F);
    ...
    if(((uint32_t)0x00000000) == (response & (uint32_t)0xFDF9E008)){
...
static sd_error_enum sd_bus_width_config(uint32_t buswidth)
{
    ...
    if(((uint32_t)0x00010000) == buswidth){
        if(((uint32_t)0x00000000) != (sd_scr[1] & buswidth)){
            ...
            sdio_command_response_config(((uint8_t)6), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
            sdio_wait_type_set((uint32_t)0x00000000U);
            sdio_csm_enable();
             
            status = r1_error_check(((uint8_t)6));
            if(SD_OK != status){
                return status;
            }
        }else{
        ...
        return status;
    }else if(((uint32_t)0x00040000) == buswidth){
        if(((uint32_t)0x00000000) != (sd_scr[1] & buswidth)){
            ...
            sdio_command_response_config(((uint8_t)6), (uint32_t)0x2, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
            sdio_wait_type_set((uint32_t)0x00000000U);
            sdio_csm_enable();
...
static sd_error_enum sd_scr_get(uint16_t rca, uint32_t *pscr)
{
    ...
    sdio_command_response_config(((uint8_t)55), (uint32_t)rca << ((uint8_t)0x10), (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
    ...
    sdio_data_config(((uint32_t)0xFFFFFFFF), (uint32_t)8, (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(3) << 4)));
    sdio_data_transfer_config((uint32_t)0x00000000U, ((uint32_t)((uint32_t)0x01U<<(1))));
    sdio_dsm_enable();
    
     
    sdio_command_response_config(((uint8_t)51), (uint32_t)0x0, (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6)));
    sdio_wait_type_set((uint32_t)0x00000000U);
    sdio_csm_enable();
     
    status = r1_error_check(((uint8_t)51));
    if(SD_OK != status){
        return status;
    }
    ...
    while(!sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(10))) | ((uint32_t)((uint32_t)0x01U<<(9))))){
        if(RESET != sdio_flag_get(((uint32_t)((uint32_t)0x01U<<(21))))){
    ...
    *(pscr) = ((temp_scr[1] & ((uint32_t)0x000000FF)) << 24) | ((temp_scr[1] & ((uint32_t)0x0000FF00)) << 8) | 
                ((temp_scr[1] & ((uint32_t)0x00FF0000)) >> 8) | ((temp_scr[1] & ((uint32_t)0xFF000000)) >> 24);
    *(pscr + 1) = ((temp_scr[0] & ((uint32_t)0x000000FF)) << 24) | ((temp_scr[0] & ((uint32_t)0x0000FF00)) << 8) | 
                ((temp_scr[0] & ((uint32_t)0x00FF0000)) >> 8) | ((temp_scr[0] & ((uint32_t)0xFF000000)) >> 24);
    return status;
}
...
static uint32_t sd_datablocksize_get(uint16_t bytesnumber)
{
    ...
    return (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(exp_val) << 4));
}
...
static void gpio_config(void)
{
    ...
    gpio_af_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000800U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(12) << 0)), ((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(10))) | ((uint32_t)((uint32_t)0x01U<<(11))) | ((uint32_t)((uint32_t)0x01U<<(12))));
    gpio_af_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000C00U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(12) << 0)), ((uint32_t)((uint32_t)0x01U<<(2))));
    
    gpio_mode_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000800U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(10))) | ((uint32_t)((uint32_t)0x01U<<(11))));
    gpio_output_options_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000800U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(10))) | ((uint32_t)((uint32_t)0x01U<<(11))));
    
    gpio_mode_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000800U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(12))));
    gpio_output_options_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000800U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(12))));
    
    gpio_mode_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000C00U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(2))));
    gpio_output_options_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000C00U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(2))));
...
static void dma_transfer_config(uint32_t *srcbuf, uint32_t bufsize)
{
    ...
    dma_flag_clear(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3, ((uint32_t)((uint32_t)0x01U<<(0))));
    dma_flag_clear(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3, ((uint32_t)((uint32_t)0x01U<<(2))));
    dma_flag_clear(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3, ((uint32_t)((uint32_t)0x01U<<(3))));
    dma_flag_clear(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3, ((uint32_t)((uint32_t)0x01U<<(4))));
    dma_flag_clear(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3, ((uint32_t)((uint32_t)0x01U<<(5))));
    dma_channel_disable(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3);
    dma_deinit(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3);
    
     
    dma_struct.periph_addr = (uint32_t)((uint32_t)0x40012C80);
    dma_struct.memory0_addr = (uint32_t)srcbuf;
    dma_struct.direction = (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 6));
    dma_struct.number = 0;
    dma_struct.periph_inc = ((uint32_t)0x00000001U);
    dma_struct.memory_inc = ((uint32_t)0x00000000U);
    dma_struct.periph_width = (((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(12)))) & ((uint32_t)(2) << 11));
    dma_struct.memory_width = (((0xFFFFFFFFUL << (13)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(14)))) & ((uint32_t)(2) << 13)); 
    dma_struct.priority = (((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(17)))) & ((uint32_t)(3) << 16));
    dma_struct.periph_burst_width = (((0xFFFFFFFFUL << (21)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(22)))) & ((uint32_t)(1) << 21));
    dma_struct.memory_burst_width = (((0xFFFFFFFFUL << (23)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(24)))) & ((uint32_t)(1) << 23));
    dma_struct.circular_mode = ((uint32_t)0x00000001U);
    dma_struct.critical_value = (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0));
    dma_multi_data_mode_init(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3, &dma_struct);
    
    dma_flow_controller_config(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3, ((uint32_t)0x00000001U));
    dma_channel_subperipheral_select(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3, DMA_SUBPERI4);
    dma_channel_enable(((((uint32_t)0x40020000U) + 0x00006000U) + 0x00000400U), DMA_CH3);
}
...
static void dma_receive_config(uint32_t *dstbuf, uint32_t bufsize)
{
    ...
    dma_struct.direction = (((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(0) << 6));
    dma_struct.number = 0;
    dma_struct.periph_inc = ((uint32_t)0x00000001U);
    dma_struct.memory_inc = ((uint32_t)0x00000000U);
    dma_struct.periph_width = (((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(12)))) & ((uint32_t)(2) << 11));
