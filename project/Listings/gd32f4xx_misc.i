#line 1 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_misc.c"
...
#line 35 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_misc.c"
                     ...
                     uint8_t nvic_irq_sub_priority)
{
    ...
    if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U) == ((uint32_t)0x700)) {
        temp_pre = 0U;
        temp_sub = 0x4U;
    } else if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U) == ((uint32_t)0x600)) {
        temp_pre = 1U;
        temp_sub = 0x3U;
    } else if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U) == ((uint32_t)0x500)) {
        temp_pre = 2U;
        temp_sub = 0x2U;
    } else if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U) == ((uint32_t)0x400)) {
        temp_pre = 3U;
        temp_sub = 0x1U;
    } else if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U) == ((uint32_t)0x300)) {
        temp_pre = 4U;
        temp_sub = 0x0U;
    } else {
        nvic_priority_group_set(((uint32_t)0x500));
        temp_pre = 2U;
        temp_sub = 0x2U;
    }
...
void nvic_irq_disable(uint8_t nvic_irq)
{
    ...
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ICER[nvic_irq >> 0x05] = (uint32_t)0x01 << (nvic_irq & (uint8_t)0x1F);
}
