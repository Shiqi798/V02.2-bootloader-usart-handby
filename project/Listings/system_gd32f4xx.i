#line 1 "..\\Driver\\Start\\CMSIS\\GD\\GD32F4xx\\Source\\system_gd32f4xx.c"
...
#line 38 "..\\Driver\\Start\\CMSIS\\GD\\GD32F4xx\\Source\\system_gd32f4xx.c"
...
#line 78 "..\\Driver\\Start\\CMSIS\\GD\\GD32F4xx\\Source\\system_gd32f4xx.c"
...
#line 124 "..\\Driver\\Start\\CMSIS\\GD\\GD32F4xx\\Source\\system_gd32f4xx.c"
uint32_t SystemCoreClock = (uint32_t)(240000000);
...
void SystemInit (void)
{
    ...
    while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(1))))){
    }
    do{ volatile uint32_t i; if(0 != 0x50){ (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) |= (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(8) << 4)); for(i=0; i<0x50; i++){ } (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) |= (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(9) << 4)); for(i=0; i<0x50; i++){ } } }while(0);
    
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1))));
    
     
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x00U)) &= ~(((uint32_t)((uint32_t)0x01U<<(24))) | ((uint32_t)((uint32_t)0x01U<<(19))) | ((uint32_t)((uint32_t)0x01U<<(16))));

     
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x00U)) &= ~(((uint32_t)((uint32_t)0x01U<<(18))));
    
     
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) = 0x00000000U;

     
    while(0 != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) & (((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(0) << 2)))){
    }
...
static void system_clock_config(void)
{
#line 211 "..\\Driver\\Start\\CMSIS\\GD\\GD32F4xx\\Source\\system_gd32f4xx.c"
    system_clock_240m_25m_hxtal();

}

#line 1054 "..\\Driver\\Start\\CMSIS\\GD\\GD32F4xx\\Source\\system_gd32f4xx.c"
...
static void system_clock_240m_25m_hxtal(void)
{
    ...
    do{
        timeout++;
        stab_flag = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(17))));
    }while((0U == stab_flag) && (((uint16_t)0xFFFF) != timeout));

     
    if(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(17))))){
        while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(17)))))
        {
        }
    }
         
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x40U)) |= ((uint32_t)((uint32_t)0x01U<<(28)));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00007000U)) + 0x00000000U)) |= ((0xFFFFFFFFUL << (14)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15))));

     
     
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) |= (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(0) << 4));
     
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) |= (((0xFFFFFFFFUL << (13)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((uint32_t)(4) << 13));
     
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) |= (((0xFFFFFFFFUL << (10)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(12)))) & ((uint32_t)(5) << 10));

      
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x04U)) = (25U | (480U << 6U) | (((2U >> 1U) - 1U) << 16U) |
                   (((uint32_t)((uint32_t)0x01U<<(22)))) | (10U << 24U));

     
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(24)));

     
    while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(25))))){
    }
    
     
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00007000U)) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(16)));
    while(0U == ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00007000U)) + 0x00000004U)) & ((uint32_t)((uint32_t)0x01U<<(16))))){
    }
    
     
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00007000U)) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(17)));
    while(0U == ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00007000U)) + 0x00000004U)) & ((uint32_t)((uint32_t)0x01U<<(17))))){
    } 
    
     
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) |= (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0));

     
    while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x08U)) & (((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(2) << 2)))){
    }
}
