#line 1 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_spi.c"
...
#line 37 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_spi.c"
#line 38 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_spi.c"
...
void spi_i2s_deinit(uint32_t spi_periph)
{
    ...
    case ((((uint32_t)0x40000000U) + 0x00003800U) + 0x00000400U):
        ...
        break;
    case ((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000FC00U):
         
        rcu_periph_reset_enable(RCU_SPI3RST);
        rcu_periph_reset_disable(RCU_SPI3RST);
        break;
    case ((((uint32_t)0x40000000U) + 0x00003800U) + 0x00011800U):
         
        rcu_periph_reset_enable(RCU_SPI4RST);
        rcu_periph_reset_disable(RCU_SPI4RST);
        break;
    case ((((uint32_t)0x40000000U) + 0x00003800U) + 0x00011C00U):
...
{
    uint32_t reg = 0U;
    reg = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U));
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) = (uint32_t)reg;
...
#line 262 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_spi.c"
    ...
    rcu_i2s_clock_config(((uint32_t)0x00000000U));

     
    plli2sm = (uint32_t)((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x04U)) & ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(5)))));
     
    plli2sn = (uint32_t)(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x84U)) & ((0xFFFFFFFFUL << (6)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(14))))) >> 6);
     
    plli2sr = (uint32_t)(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x84U)) & ((0xFFFFFFFFUL << (28)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(30))))) >> 28);

    if(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003800U) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(22)))) == ((uint32_t)((uint32_t)0x01U<<(22)))) {
         
        i2sclock = (uint32_t)(((((uint32_t)25000000) / plli2sm) * plli2sn) / plli2sr);
    } else {
         
        i2sclock = (uint32_t)(((((uint32_t)16000000) / plli2sm) * plli2sn) / plli2sr);
    }
    ...
    if(((uint32_t)((uint32_t)0x01U<<(9))) == i2s_mckout) {
        ...
        if((((0xFFFFFFFFUL << (1)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2))))&((uint32_t)(0)<<1)) == i2s_frameformat) {
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000020U)) = (uint32_t)(i2sdiv | i2sof | i2s_mckout);
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU)) |= (uint32_t)i2s_frameformat;
}
...
void spi_i2s_data_frame_format_config(uint32_t spi_periph, uint16_t frame_format)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= (uint32_t)frame_format;
}
                                 ...
                                 uint32_t i2s_ckpl, uint32_t i2s_frameformat)
{
    ...
    reg = (*(volatile uint32_t *)(uint32_t)((i2s_add_periph) + 0x0000001CU));
    reg &= ((uint32_t)0x00000480U);

     
    if(((((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(9))))&((uint32_t)(2)<<8)) == i2s_mode) || ((((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(9))))&((uint32_t)(0)<<8)) == i2s_mode)) {
        tmp = (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(9))))&((uint32_t)(1)<<8));
    } else {
        tmp = (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(9))))&((uint32_t)(0)<<8));
    }
    ...
    (*(volatile uint32_t *)(uint32_t)((i2s_add_periph) + 0x0000001CU)) = (uint32_t)reg;
}
...
FlagStatus spi_i2s_flag_get(uint32_t spi_periph, uint32_t flag)
{
    if((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000008U)) & flag) {
        return SET;
    } else {
        return RESET;
    }
...
void spi_i2s_interrupt_enable(uint32_t spi_periph, uint8_t interrupt)
{
    ...
    case ((uint8_t)0x00U):
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(7)));
        break;
     
    case ((uint8_t)0x01U):
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(6)));
        break;
     
    case ((uint8_t)0x02U):
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(5)));
        break;
    default:
        break;
    }
