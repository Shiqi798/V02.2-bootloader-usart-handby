...
#line 4 "..\\Driver\\HardWare\\USART\\USART.c"
#line 5 "..\\Driver\\HardWare\\USART\\USART.c"
#line 6 "..\\Driver\\HardWare\\USART\\USART.c"
#line 7 "..\\Driver\\HardWare\\USART\\USART.c"
#line 8 "..\\Driver\\HardWare\\USART\\USART.c"
...
#line 9 "..\\Driver\\HardWare\\USART\\USART.c"
...
#pragma __printf_args
extern __declspec(__nothrow) int rs485_printf(const char * __restrict  , ...) __attribute__((__nonnull__(1)));
...
#line 10 "..\\Driver\\HardWare\\USART\\USART.c"
...
#line 11 "..\\Driver\\HardWare\\USART\\USART.c"
...
{
    dma_channel_disable(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH6);
    dma_flag_clear(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH6, ((uint32_t)((uint32_t)0x01U<<(5))));
    usart_flag_clear((((uint32_t)0x40000000U) + 0x00004400U), USART_FLAG_TC);
}
...
void USART1_Init(void)
{
    ...
    usart_baudrate_set((((uint32_t)0x40000000U) + 0x00004400U), 115200);
...
void USART1_IRQHandler(void)
{
    ...
    if (RESET != usart_interrupt_flag_get((((uint32_t)0x40000000U) + 0x00004400U), USART_INT_FLAG_IDLE))
    {
        ...
        if (usart1_rx_len >= 1152U) {
            usart1_rx_len = 1152U - 1U;
        }
