#line 1 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_crc.c"
...
#line 36 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_crc.c"
...
uint32_t crc_single_data_calculate(uint32_t sdata)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003000U) + 0x00000000U)) = sdata;
...
uint32_t crc_block_data_calculate(uint32_t array[], uint32_t size)
{
    ...
    for(index = 0U; index < size; index++) {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003000U) + 0x00000000U)) = array[index];
    }
    return ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003000U) + 0x00000000U)));
}
