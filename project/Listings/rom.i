#line 1 "..\\Driver\\HardWare\\ROM\\ROM.c"
...
#line 2 "..\\Driver\\HardWare\\ROM\\ROM.c"
...
#line 4 "..\\Driver\\HardWare\\ROM\\ROM.c"
...
{
    fmc_flag_clear(((uint32_t)((uint32_t)0x01U<<(0))));
    fmc_flag_clear(((uint32_t)((uint32_t)0x01U<<(4))));
    fmc_flag_clear(((uint32_t)((uint32_t)0x01U<<(7))));
    fmc_flag_clear(((uint32_t)((uint32_t)0x01U<<(6))));
}
...
_Bool ROM_erase_range(uint32_t start_addr, uint32_t size)
{
    ...
    uint32_t aligned_start = start_addr & ~(0x00001000U - 1U);
    uint32_t aligned_end = (end_addr + 0x00001000U - 1U) & ~(0x00001000U - 1U);

    if ((size == 0U) || (start_addr < 0x08000000U) || (end_addr > (0x08000000U + 0x00080000U)) ||
        (end_addr < start_addr)) {
        return 0;
    }
    ...
    fmc_unlock();
    rom_clear_status_flags();
    for (uint32_t page = aligned_start; page < aligned_end; page += 0x00001000U) {
...
_Bool ROM_buffer_write(uint32_t addr, const uint8_t *data, uint32_t len)
{
    ...
    if ((addr < 0x08000000U) || ((addr + len) > (0x08000000U + 0x00080000U)) ||
        ((addr & 3U) != 0U)) {
        return 0;
    }
