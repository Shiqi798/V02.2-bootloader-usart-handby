#line 1 "..\\Driver\\HardWare\\KEY\\Key.c"
...
#line 2 "..\\Driver\\HardWare\\KEY\\Key.c"

 


uint8_t g_key_stable_level[4] = {0};
uint8_t Key_flag[4];
int16_t CalcCount=0;
int16_t CalcMode=0;
uint8_t LED_Mode =0;
int16_t Count[3]={0};
uint8_t prev_real_level[4] = {0}; 
...
void Key_Init(void)
{
	...
	gpio_mode_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(15))) | ((uint32_t)((uint32_t)0x01U<<(11))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(7))));
}
