...
_Bool boot_app_vector_ok(uint32_t addr)
{
    ...
    return (sp >= 0x20000000U) &&
           ...
           ((sp & 3U) == 0U) &&
           (pc >= 0x08000000U) &&
           (pc < (0x08000000U + 0x00080000U)) &&
           ((pc & 1U) != 0U);
}

_Bool boot_app_can_boot(void)
{
    return boot_app_vector_ok(0x08011000U);
}
...
void boot_app_jump_raw(uint32_t addr)
{
    ...
    usart_dma_receive_config((((uint32_t)0x40000000U) + 0x00004400U), (((uint32_t)((uint32_t)0x01U<<(6))) & ((uint32_t)(0) << 6)));
    ...
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = 0U;
