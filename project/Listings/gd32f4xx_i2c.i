#line 1 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_i2c.c"
...
#line 36 "..\\Driver\\Library\\GD32F4xx_standard_peripheral\\Source\\gd32f4xx_i2c.c"
...
void i2c_deinit(uint32_t i2c_periph)
{
    ...
    case ((((uint32_t)0x40000000U) + 0x00005400U) + 0x00000400U):
        ...
        break;
    case ((((uint32_t)0x40000000U) + 0x00005400U) + 0x00000800U):
...
void i2c_clock_config(uint32_t i2c_periph, uint32_t clkspeed, uint32_t dutycyc)
{
    ...
    if(freq >= ((uint32_t)0x0000003CU)) {
        freq = ((uint32_t)0x0000003CU);
    }
    ...
    if(100000U >= clkspeed) {
        ...
        if(risetime >= ((uint32_t)0x0000003CU)) {
            (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000020U)) = ((uint32_t)0x0000003CU);
...
void i2c_analog_noise_filter_disable(uint32_t i2c_periph)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000024U)) |= ((uint32_t)((uint32_t)0x01U<<(4)));
}
...
void i2c_digital_noise_filter_config(uint32_t i2c_periph, i2c_digital_filter_enum dfilterpara)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000024U)) |= dfilterpara;
}
