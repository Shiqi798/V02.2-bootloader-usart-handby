...
uint16_t get_usart1_rx_len(void)
{
    return 256 - dma_transfer_number_get(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH5);
}
...
void reset_usart1_rx_dma(void)
{
    ...
    dma_transfer_number_config(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH5, 256);
    dma_channel_enable(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH5);
}
