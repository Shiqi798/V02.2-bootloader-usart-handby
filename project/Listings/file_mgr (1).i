...
#line 2 "..\\sysfunction\\file_mgr.c"
#line 3 "..\\sysfunction\\file_mgr.c"
#line 4 "..\\sysfunction\\file_mgr.c"
#line 5 "..\\sysfunction\\file_mgr.c"
#line 6 "..\\sysfunction\\file_mgr.c"
#line 7 "..\\sysfunction\\file_mgr.c"
...
void file_mgr_init(void)
{
	...
	if(RES_OK == stat)						 
	{      
		res = f_open(&fdst,"0:/Task.bin",0x01); 
		if(res != FR_OK)					 
		{
			rs485_printf("Failed to open file: %d\n", res);
			return;
		}
		uint32_t br_temp = 0;
		br=0;
		int j=flash_erase_nsector(0x08008000U,64); 
		OLED_Printf(0,16,16,"ERASE:%d", j);
		OLED_Refresh();
		while(1)
		{
			
			res = f_read(&fdst, app_buf, 512u, &br);
			...
			flash_write_app(0x08008000U + br_temp, app_buf, br);
